...
class Plain3DUNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, base_filters=18):
        ...
        # --- Bottleneck ---
        # Standard DoubleConv (No Context Block, No Dilation)
    ...
    def forward(self, x):
        ...
        # Decoder (with padding handling for non-power-of-2 shapes)
        d1 = self.up1(b)
