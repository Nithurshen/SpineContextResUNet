...
# UPDATED: Path for the 3D U-Net model
...
def save_visual(ct_vol, pred_mask, cam_vol, subject_id, output_dir):
    ...
    plt.tight_layout()
    output_path = os.path.join(output_dir, f"3dunet.png")
...
def run_evaluation():
    ...
    # UPDATED: Instantiating the Plain 3D U-Net
    ...
    # UPDATED: Target Layer for Grad-CAM
    # In this architecture, 'dec4' is the final decoder block before the output layer
    grad_cam = SpineGradCAM(model, model.dec4)
