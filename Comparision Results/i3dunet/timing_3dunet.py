import os
# Must be set before torch is imported to handle MaxPool3d on MPS
...
# Update path to find the i3dunet model
sys.path.append('Comparision Results/i3dunet')
...
def run_test():
    ...
    for dev_type in devices:
        ...
        print(f"\n--- Testing Plain3DUNet on {dev_type.upper()} ---")
        
        # Initialize model with base_filters=9 as per your architecture
        model = Plain3DUNet(in_channels=1, out_channels=1, base_filters=9)
