...
# UPDATED: Path for the Linear Dilation model
# Make sure this file exists in your models directory!
...
def save_visual(ct_vol, pred_mask, cam_vol, subject_id, output_dir):
    ...
    plt.tight_layout()
    output_path = os.path.join(output_dir, f"linear_dilation.png")
...
def run_evaluation():
    ...
    # UPDATED: Instantiating the Linear Dilation Model
    ...
    # Initialize GradCAM on the target layer (model.dec1 is correct for this arch too)
