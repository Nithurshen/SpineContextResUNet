...
# UPDATED: Path for the No Dilation model
# Make sure this matches your actual checkpoint filename
...
def save_visual(ct_vol, pred_mask, cam_vol, subject_id, output_dir):
    ...
    plt.tight_layout()
    output_path = os.path.join(output_dir, f"no_dilation.png")
...
def run_evaluation():
    ...
    # UPDATED: Instantiating the No Dilation Model
